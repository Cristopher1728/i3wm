...
pkg install xfce4 i3 tigervnc tilix ruby wget fastfetch vim htop w3m sc sc-im mc cmatrix rofi nitrogen lxappearance picom pipewire vlc-qt papirus-icon-theme cmatrix polybar neofetch htop xarchiver pcmanfm gimp vlc curl chromium -y
