sudo apt install curl chromium chromium-l10n suckless-tools i3blocks nitrogen rofi lxappearance picom numlockx pulseaudio pulseaudio-utils pavucontrol arc-theme papirus-icon-theme lolcat psensor polybar tilix neofetch htop btop glances xarchiver pcmanfm synaptic gparted conky conky-all
